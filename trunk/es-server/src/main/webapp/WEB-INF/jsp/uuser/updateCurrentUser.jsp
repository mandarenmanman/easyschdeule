                ...
                <div class="message-wrapper" id="message-wrapper">
                    <div class="message-title">
                        <ul>
                            ...
                            <li class="cur"><a href="#"><span>修改密码</span></a></li>
                        </ul>
                    </div>
                    <div class="clearing"></div>
                    <s:form action="updateCurrentUser.action" method="post" id="updateUserForm" theme="simple">
                    <s:token/>
