                ...
                <div class="message-wrapper" id="message-wrapper">
                    <div class="message-title">
                        <ul>
                            ...
                            <li class="cur"><a href="viewAddConfig"><span>参数添加</span></a></li>
                            <li><a href="viewOtherConfig"><span>系统参数</span></a></li>
                        </ul>
                    </div>
                    <div class="clearing"></div>
                    <s:form action="addConfig.action" method="post" id="addConfigForm" theme="simple">
                    <s:token/>
...
<script type="text/javascript">
    $(document).ready(function() {
        $.formValidator.initConfig({formid:"addConfigForm",onerror:function(msg) {
            alert(msg);
        }});
        $('#configkey').formValidator({
            onshow :"请输入参数KEY",
