                ...
                <div class="message-wrapper" id="message-wrapper">
                    <div class="message-title">
                        <ul>
                            ...
                            <li class="cur"><a href="testDataTrackingJob"><span>数据监控请求测试</span></a></li>
                        </ul>
                    </div>
                    ...
                    <form name="completeJob.action" method="post"
                        ...
                        <div class="add-wrapper">
                            <table>
                                ...
                                <tr>
                                    <td>执行命令：</td>
                                    <td><input type="text" id="trackingSql" name="trackingSql" style="width:300px;" size="60"
                                               value="select ceil( rand()*100)"/>
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="sync" name="sync" style="width:304px;">
                                            ...
                                            <option value="true" selected>同步</option>
                                        </select>
                                    </td>
                                    <td>
                                    </td>
